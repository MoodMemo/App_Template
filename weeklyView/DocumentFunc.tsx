...
export function getStamp(date: Moment): repository.IPushedStamp[] {
  ...
  repository.tmppp("dateTime", dateToCompareBegin, dateToCompareEnd).forEach((pushedStamp) => {
...
const createDefaultPushedStamp = () => {
  repository.createPushedStamp({
    dateTime: new Date("2023-08-01 09:00:00"),
    stampName: "기쁨",
    emoji: "😆",
    memo: "기쁨 스탬프 눌렀다무",
    imageUrl: "이미지는 안넣었다무"
  ...
  repository.createPushedStamp({
    dateTime: new Date("2023-08-01 10:00:00"),
    stampName: "슬픔",
    emoji: "😭",
    memo: "슬픔 스탬프 눌렀다무",
    imageUrl: "이미지는 안넣었다무"
  ...
  repository.createPushedStamp({
    dateTime: new Date("2023-07-31 09:00:00"),
    stampName: "기쁨",
    emoji: "😆",
    memo: "기쁨 스탬프 눌렀다무",
    imageUrl: "이미지는 안넣었다무"
  ...
  repository.createPushedStamp({
    dateTime: new Date("2023-07-31 10:00:00"),
    stampName: "슬픔",
    emoji: "😭",
    memo: "슬픔 스탬프 눌렀다무",
    imageUrl: "이미지는 안넣었다무"
